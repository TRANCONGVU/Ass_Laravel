	<section class="banner-slider">
		<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
			...
			<div class="ws_images"><ul>
				<li><img src="image/anh.jpg" alt="banner-1" title="banner-1" id="wows1_0"/></li>
				<li><img src="image/anh.jpg" alt="banner-2" title="banner-2" id="wows1_1"/></li>
				<li><img src="image/anh.jpg" alt="banner-3" title="banner-3" id="wows1_2"/></li>
				<li><img src="image/anh.jpg" alt="banner-4" title="banner-4" id="wows1_3"/></a></li>
				<li><img src="image/anh.jpg" alt="banner-5" title="banner-5" id="wows1_4"/></li>
			</ul></div>
